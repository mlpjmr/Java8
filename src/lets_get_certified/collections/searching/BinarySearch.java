...
public class BinarySearch {
    ...
    public static void searchCats(){
        Catcomp fluffy = new Catcomp("Fluffy", 1);
        Catcomp bella  = new Catcomp("Bella", 5);
        List<Catcomp> catList = Arrays.asList(fluffy, bella);
        ...
        Comparator<Catcomp> byAge = (cat1, cat2) -> cat1.getAge() - cat2.getAge();
